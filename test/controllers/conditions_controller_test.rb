...
class ConditionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create condition" do
    assert_difference('Condition.count') do
      post conditions_url, params: { condition: { comment: @condition.comment, date: @condition.date, name: @condition.name, progress: @condition.progress, user_id: @condition.user_id } }
    end
  ...
  test "should update condition" do
    patch condition_url(@condition), params: { condition: { comment: @condition.comment, date: @condition.date, name: @condition.name, progress: @condition.progress, user_id: @condition.user_id } }
